...
def processAll(text, subject='', query=[]):
	...
	return text
#tweet="@ClaireBoyllllllllllllllllllllllllllllllles good tipppppppppppppp..... but then my boss would read .... exactly what im supposed to do and would know where I was with the project :) !!!!!!!!!!!"
#print processAll(tweet)
